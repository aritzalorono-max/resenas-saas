    ...
    sections: [
      ...
      },
      {
        ...
        content: [
          ...
          "• AVISO IMPORTANTE SOBRE INCENTIVOS: Las políticas de Google prohíben expresamente ofrecer incentivos (descuentos, regalos, compensaciones económicas o de cualquier tipo) a cambio de reseñas. El uso del sistema de incentivos de ResenasYa puede suponer una infracción de dichas políticas y podría conllevar la eliminación de reseñas o la suspensión del perfil de Google Business Profile del usuario. El usuario asume íntegramente la responsabilidad del uso del sistema de incentivos y sus consecuencias. Buy & Click, SL no será responsable de ninguna sanción, eliminación de reseñas o suspensión de perfil derivada de dicho uso.",
      ...
      },
      {
        ...
        content: [
          ...
          "• Buy & Click, SL no será responsable de la suspensión, penalización o eliminación del perfil de Google Business Profile del usuario como consecuencia del uso de respuestas automáticas generadas por inteligencia artificial, del volumen de respuestas publicadas o de cualquier otra actuación realizada a través de la Plataforma.",
        ],
      },
      {
    ...
    sections: [
      ...
      },
      {
        ...
        content: [
          ...
          "• IMPORTANT NOTICE ON INCENTIVES: Google's policies expressly prohibit offering incentives (discounts, gifts, financial compensation or any other form) in exchange for reviews. Use of ResenasYa's incentive system may violate those policies and could result in the removal of reviews or the suspension of the user's Google Business Profile. The user assumes full responsibility for using the incentive system and any consequences thereof. Buy & Click, SL shall not be liable for any penalty, review removal or profile suspension arising from such use.",
      ...
      },
      {
        ...
        content: [
          ...
          "• Buy & Click, SL shall not be liable for the suspension, penalisation or removal of the user's Google Business Profile as a result of the use of AI-generated automated replies, the volume of replies published or any other action carried out through the Platform.",
        ],
      },
      {
    ...
    sections: [
      ...
      },
      {
        ...
        content: [
          ...
          "• AVIS IMPORTANT SUR LES INCITATIONS : Les politiques de Google interdisent expressément d'offrir des incitations (remises, cadeaux, compensations financières ou de toute autre nature) en échange d'avis. L'utilisation du système d'incitations de ResenasYa peut constituer une violation de ces politiques et pourrait entraîner la suppression d'avis ou la suspension du profil Google Business Profile de l'utilisateur. L'utilisateur assume l'entière responsabilité de l'utilisation du système d'incitations et de ses conséquences. Buy & Click, SL ne sera pas responsable des sanctions, suppressions d'avis ou suspensions de profil résultant de cette utilisation.",
      ...
      },
      {
        ...
        content: [
          ...
          "• Buy & Click, SL ne sera pas responsable de la suspension, de la pénalisation ou de la suppression du profil Google Business Profile de l'utilisateur résultant de l'utilisation de réponses automatiques générées par l'IA, du volume de réponses publiées ou de toute autre action effectuée via la Plateforme.",
        ],
      },
      {
    ...
    sections: [
      ...
      },
      {
        ...
        content: [
          ...
          "• WICHTIGER HINWEIS ZU ANREIZEN: Googles Richtlinien verbieten ausdrücklich das Anbieten von Anreizen (Rabatte, Geschenke, finanzielle oder andere Kompensationen) im Austausch für Bewertungen. Die Nutzung des Anreizsystems von ResenasYa kann gegen diese Richtlinien verstoßen und zur Entfernung von Bewertungen oder zur Sperrung des Google Business Profile des Nutzers führen. Der Nutzer übernimmt die volle Verantwortung für die Nutzung des Anreizsystems und dessen Folgen. Buy & Click, SL haftet nicht für Strafen, Bewertungslöschungen oder Profilsperrungen, die sich aus einer solchen Nutzung ergeben.",
      ...
      },
      {
        ...
        content: [
          ...
          "• Buy & Click, SL haftet nicht für die Sperrung, Bestrafung oder Löschung des Google Business Profile des Nutzers infolge der Nutzung KI-generierter automatischer Antworten, des Volumens veröffentlichter Antworten oder sonstiger über die Plattform durchgeführter Aktionen.",
        ],
      },
      {
    ...
    sections: [
      ...
      },
      {
        ...
        content: [
          ...
          "• AVVISO IMPORTANTE SUGLI INCENTIVI: Le politiche di Google vietano espressamente di offrire incentivi (sconti, regali, compensazioni economiche o di qualsiasi tipo) in cambio di recensioni. L'uso del sistema di incentivi di ResenasYa può costituire una violazione di tali politiche e potrebbe comportare la rimozione di recensioni o la sospensione del profilo Google Business Profile dell'utente. L'utente si assume la piena responsabilità dell'utilizzo del sistema di incentivi e delle sue conseguenze. Buy & Click, SL non sarà responsabile di sanzioni, rimozioni di recensioni o sospensioni di profilo derivanti da tale utilizzo.",
      ...
      },
      {
        ...
        content: [
          ...
          "• Buy & Click, SL non sarà responsabile della sospensione, penalizzazione o rimozione del profilo Google Business Profile dell'utente a seguito dell'uso di risposte automatiche generate dall'IA, del volume di risposte pubblicate o di qualsiasi altra azione effettuata tramite la Piattaforma.",
        ],
      },
      {
    ...
    sections: [
      ...
      },
      {
        ...
        content: [
          ...
          "• AVISO IMPORTANTE SOBRE INCENTIVOS: As políticas do Google proíbem expressamente a oferta de incentivos (descontos, ofertas, compensações financeiras ou de qualquer tipo) em troca de avaliações. A utilização do sistema de incentivos da ResenasYa pode constituir uma violação dessas políticas e pode resultar na remoção de avaliações ou na suspensão do perfil Google Business Profile do utilizador. O utilizador assume a total responsabilidade pela utilização do sistema de incentivos e pelas suas consequências. A Buy & Click, SL não será responsável por sanções, remoções de avaliações ou suspensões de perfil decorrentes dessa utilização.",
      ...
      },
      {
        ...
        content: [
          ...
          "• A Buy & Click, SL não será responsável pela suspensão, penalização ou remoção do perfil Google Business Profile do utilizador resultante da utilização de respostas automáticas geradas por IA, do volume de respostas publicadas ou de qualquer outra ação realizada através da Plataforma.",
        ],
      },
      {
