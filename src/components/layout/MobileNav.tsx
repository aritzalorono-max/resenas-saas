...
import { LayoutDashboard, Users, CalendarDays, Star, Settings, ClipboardList, Building2, Scale } from 'lucide-react'
...
const NAV = [
  ...
  { href: '/reglas',     label: 'Reglas',     icon: <Scale size={20} />,           roles: ['admin','gestor'] },
